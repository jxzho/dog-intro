<template>
  <div class="intro">
    <div class="avatar-wrapper">
      <div class="avatar"
         @mouseenter="dialogueShow = true"
         @mouseleave="dialogueShow = false">
    ...
    <div class="title-social-wrapper">
      <p class="title">前端学习生，感谢光临<span class="right">&#xe602;</span></p>
      <div class="social">
